...
filelist <- list.files("D:/Surface 3/Main Folder/Documents/Lab Data/2019_11 Soil Incubation Study/NOx/Raw Data/")
...
noxfile$TheTime <- as.POSIXct(noxfile$TheTime*(60*60*24)+(3600*4), origin = "1899-12-30")
...
## Shorten to 22 hour time frames for ease
...
h2ofile <- list.files("D:/Surface 3/Main Folder/Documents/Lab Data/2019_11 Soil Incubation Study/Absolute Humidity/", pattern = gsub("-","_",as.Date(datetime[1])))
h2o <- read.csv(paste0("D:/Surface 3/Main Folder/Documents/Lab Data/2019_11 Soil Incubation Study/Absolute Humidity/",h2ofile), header = TRUE, stringsAsFactors = FALSE)
