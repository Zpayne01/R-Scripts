...
chamberaamb <- chambera[seq(1, nrow(chambera), 2),]
chamberbamb <- chamberb[seq(1, nrow(chamberb), 2),]
chambercamb <- chamberc[seq(1, nrow(chamberc), 2),]
chamberdamb <- chamberd[seq(1, nrow(chamberd), 2),]
