...
chamberames <- subset(chambera, chambera$min == 7 & chambera$no > 0)
chamberbmes <- subset(chamberb, chamberb$min == 22 & chamberb$no > 0)
chambercmes <- subset(chamberc, chamberc$min == 37 & chamberc$no > 0)
chamberdmes <- subset(chamberd, chamberd$min == 52 & chamberd$no > 0)

chamberamesno <- chamberames
chamberbmesno <- chamberbmes
chambercmesno <- chambercmes
chamberdmesno <- chamberdmes
