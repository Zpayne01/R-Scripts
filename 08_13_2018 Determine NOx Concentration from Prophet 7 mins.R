...
trimchambera <- subset(chambera, subset = ( min == 1 | min == 2 | min == 4 | min == 6 | min == 8 | min == 10 | 
                                              min == 12 | min == 14) & sec >= 15)
trimchamberb <- subset(chamberb, subset = ( min == 16 | min == 17 | min == 19 | min == 21 |min == 23 | 
                                              min == 25 | min == 27 | min == 29) & sec >= 15)
trimchamberc <- subset(chamberc, subset = ( min == 31 | min == 32 | min == 34 | min == 36 |min == 38 | 
                                              min == 40 | min == 42 | min == 44)  & sec >= 15)
trimchamberd <- subset(chamberd, subset = ( min == 46 | min == 47 | min == 49 | min == 51 |min == 53 | 
                                              min == 55 | min == 57 | min == 59) & sec >= 15)
...
final <- cbind.fill(finalchambera, finalchamberb,finalchamberc,finalchamberd)
...
write.csv(final, file = "C:/Users/Zachary/Desktop/Outdoor Test NOy.csv", row.names = FALSE)
